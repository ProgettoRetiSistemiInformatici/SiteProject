    ...
    while($obj = $result->fetch_object()){ ?>
      <div class="gallery">
        ...
        <div class="desc"> <?php echo $obj->description ?> | 
        	<div class="fb-share-button" data-href="http://test.com/comments.php?photo=<?php echo $obj->name?>" data-layout="button_count" data-size="small" data-mobile-iframe="true">
